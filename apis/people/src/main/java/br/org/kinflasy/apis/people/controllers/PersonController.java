...
public class PersonController {
    ...
    @PostMapping("search-birthdays")
    @Operation(summary = "Identificar aniversariantes", description = "Identificar aniversariantes pelos IDs e intervalo de datas.")
    public ResponseEntity<List<PersonIdentifierDto.WithBirthday>> searchBirthdaysIn(
            @RequestBody @Valid final BirthdaySearchRequest request) {
        return ResponseEntity.ok(service.searchBirthdaysIn(request));
    }
